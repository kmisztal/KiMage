package kimage.tools.math.clusters;
...
public class Cluster {
    ...
    public Cluster addTo(Cluster B) {//A=A+B        
        ...
        this.setCov(this.getCov().scale(pA).plus(pB,B.getCov()).plus(this.getMean().minus(B.getMean()).scale(pA * pB).times(this.getMean().minus(B.getMean()).transpose())));
